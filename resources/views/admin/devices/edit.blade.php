...
@section('title', 'Edit Device - Smart Rental Hub')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('daily_rate') is-invalid @enderror" 
                                       ...
                                       value="{{ old('daily_rate', $device->daily_rate) }}" required>
                            </div>
                            @error('daily_rate')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('deposit_amount') is-invalid @enderror" 
                                       ...
                                       value="{{ old('deposit_amount', $device->deposit_amount) }}" required>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" 
                                ...
                                <option value="rented" {{ old('status', $device->status) == 'rented' ? 'selected' : '' }}>Rented</option>
                                <option value="maintenance" {{ old('status', $device->status) == 'maintenance' ? 'selected' : '' }}>Under Maintenance</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" 
                                       ...
                                       {{ old('is_featured', $device->is_featured) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('condition') is-invalid @enderror" 
                                ...
                                <option value="good" {{ old('condition', $device->condition) == 'good' ? 'selected' : '' }}>Good</option>
                                <option value="fair" {{ old('condition', $device->condition) == 'fair' ? 'selected' : '' }}>Fair</option>
                                <option value="poor" {{ old('condition', $device->condition) == 'poor' ? 'selected' : '' }}>Poor</option>
                            </select>
                            @error('condition')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="4" required>{{ old('description', $device->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('specifications') is-invalid @enderror" 
                                      id="specifications" name="specifications" rows="4">{{ old('specifications', $device->specifications) }}</textarea>
